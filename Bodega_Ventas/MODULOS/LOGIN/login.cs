    ...
    public partial class login : Form
    {
            ...
            if (conta > 0) 
            {
                ...
                else
                {
                    if (lblRol.Text != "Vendedor")
                    {
                        ...
                        if (contaMovCaja == 0)
                        {
                            if (lblUsuIniCaja.Text != "AdminGaaa" & txtPruebaLogin.Text == "AdminGaaa")
                            {
                            ...
                            else if (lblUsuIniCaja.Text != txtPruebaLogin.Text & txtPruebaLogin.Text!= "AdminGaaa")
                            {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtPruebaLogin.Text == "AdminGaaa")
                {
                    EditarInicioSesion();
                    this.Hide();
                    DASHBOARD.Dashboard_Principal dash = new DASHBOARD.Dashboard_Principal();
                    dash.ShowDialog();
                    //Dispose();
                    this.Hide();
                }
                else if (lblAperturaCaja.Text == "Nuevo***" & lblRol.Text == "Cajero")
                {
                    EditarInicioSesion();
                    this.Hide();
                ...
                {
                    if (lblAperturaCaja.Text != "Nuevo***" & lblRol.Text == "Cajero")
                    {
                        EditarInicioSesion();
                        this.Hide();
        ...
        private void EditarInicioSesion()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@id_serialpc", lblSerialPc.Text);
                cmd.ExecuteNonQuery();
                con.Close();
